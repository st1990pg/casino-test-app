...
export default {
  [LOCALES.ENGLISH]: {
    ...
    USERNAME: 'Username',
    EMAIL: 'E-mail',
    FRST_NAME: 'First name',
    LAST_NAME: 'Last name',
    PASSWORD: 'Password',
    PASSWORD_CON: 'Password Confirm',
    NEXT: 'Next',
    SAVE: 'Save',
    ...
    password_confirm_failed: 'Confirm Password is not ok!',
    ...
    COMPILTED_REGISTRATION:
      'Thank you for signing up on our site. We wish you good luck and lots of fun!',
    REGISTRATION_SUCC: 'Registration successful',
    WELCOME: 'Welcome in casino!',
    SING_UP: 'Sign up now',
    GET_BONUS: 'Get 100% Bonus with x5 step! ',
    BACK: 'Back',
  },
};
